...
int main(){//Start of the main body function
	...
	fptr=fopen("E:\\Softwares\\C_Programs\\Archit_120_C_Programs_Repository\\031_ReadWriteMarks.txt","wb"); //Opening the file from the location.
	...
	fclose(fptr);
	fptr=fopen("E:\\Softwares\\C_Programs\\Archit_120_C_Programs_Repository\\031_ReadWriteMarks.txt","rb");
